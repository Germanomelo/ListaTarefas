...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Nova tarefa
        findViewById(R.id.fab).setOnClickListener(view -> startActivity(new Intent(getApplicationContext(), TaskActivity.class)));
    ...
    private void loadObservers() {
        this.mMainViewModel.userData.observe(this, model -> {
            ...
            textEmail.setText(model.getEmail()==null?"":model.getEmail());
        });
    }
}