...
public class TaskRepository extends BaseRepository{
    ...
    public void create(TaskModel taskModel, final APIListener<Boolean> listener) {
        ...
        this.callbackBoolean(call, listener);
    }
    ...
    public void all(final APIListener<List<TaskModel>> listener) {
        ...
        this.callbackList(call, listener);
    }
    ...
    public void load(int id, final APIListener<TaskModel> listener) {
        ...
        if (!super.isConnectionAvailable()) {
            listener.onFail(mContext.getString(R.string.ERROR_INTERNET_CONNECTION));
            return;
        }
    ...
    private void callbackList(Call<List<TaskModel>> call, final APIListener<List<TaskModel>> listener) {
    ...
    private void callbackBoolean(Call<Boolean> call, final APIListener<Boolean> listener) {
